...
class TACREDProcessor(DataProcessor):
    """
    `TAC Relation Extraction Dataset (TACRED) <https://nlp.stanford.edu/projects/tacred/>`_ is one of the largest and most widely used dataset for relation classification.
    ...
    ..  code-block:: python
        ...
        base_path = "dataset/RelationClassification"
